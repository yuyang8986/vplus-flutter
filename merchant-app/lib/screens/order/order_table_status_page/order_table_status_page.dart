...
import 'package:vplus_merchant_app/locator.dart';
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '${AppLocalizationHelper.of(context).translate("Order Number")}: ${o.userOrderId}',
                    ...
                    child: Center(
                      child: Text(
                        '${AppLocalizationHelper.of(context).translate("Total")}: \$' +
                            '${getTotalAmount(o).toStringAsFixed(2)}',
                        style: GoogleFonts.lato(
                            fontSize: SizeHelper.isMobilePortrait
                                ? 2 * SizeHelper.textMultiplier
                                : 2 * SizeHelper.textMultiplier,
  ...
  Widget _showSingleExtraOrder(ExtraOrder e, BuildContext context) {
    return Container(
      child: Column(
        children: [
          _getTitle(
              '${AppLocalizationHelper.of(context).translate("Extra Order Title")}',
              DateTimeHelper.parseDateTimeToDateHHMM(
