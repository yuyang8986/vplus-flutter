...
class DateTimeHelper {
  ...
  static String parseDateTimeToUTC(DateTime dateTime) {
    return parseDateTimeToDate(dateTime.toUtc());
  }

  static String parseDateTimeToCsharpFormat(DateTime dateTime) {
    return DateFormat("yyyy-MM-ddTkk:mm:ss").format(dateTime);
  }
