...
import 'package:vplus_merchant_app/helpers/locationHelper.dart';
...
class PlaceApiHelper {
  ...
  static final String androidKey = LocationHelper.GOOGLE_KEY;
  static final String iosKey = LocationHelper.GOOGLE_KEY;
