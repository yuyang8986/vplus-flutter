...
///The reason for this custom alert dialog is to resolve the issue when putting
///listview in the alertdialog will cause intrinsic demnsion error
class CustomNoIntrinsicAlertDialog extends StatelessWidget {
  ...
  const CustomNoIntrinsicAlertDialog({
    Key key,
    this.title,
    this.titlePadding,
    this.content,
