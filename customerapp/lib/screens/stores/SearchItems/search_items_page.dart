...
import 'package:vplus/screens/stores/item_category_detailed_page.dart';
...
class _SearchStoresPageState extends State<SearchItemsPage> {
  String searchInput;
  ...
  Widget searchResultListView() {
    return Consumer<GroceriesItemProvider>(builder: (ctx, p, w) {
      List<MenuItem> searchResult = p.searchedItems;
